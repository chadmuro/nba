<div class="bg-base-200">
	<div class="py-36">
		<div class="hero-content text-center ">
			<div class="max-w-lg">
				<h1 class="text-5xl font-bold">NBA Pick'em</h1>
				<p class="py-6">
					Welcome to NBA Pick'em. Choose a winner every night and climb the leaderboard!
				</p>
		...
		<div class="mt-20 text-center">
			...
			<div class="flex justify-center">
				<div class="flex flex-col items-center justify-between w-48 p-2">
					<h3 class="text-xl">Dallas Mavericks</h3>
					<img
						class="h-36 w-36"
